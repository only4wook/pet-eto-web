...
const SYMPTOM_DB: { keyword: string; weight: number; label: string }[] = [
  ...
  { keyword: "침 흘", weight: 3, label: "과다 침흘림" },
  { keyword: "침흘", weight: 3, label: "과다 침흘림" },
  { keyword: "유연", weight: 3, label: "과다 침흘림" },
  { keyword: "거품", weight: 3, label: "구강 거품/중독 의심" },
  { keyword: "입을 벌", weight: 3, label: "호흡 이상" },
  { keyword: "입벌림", weight: 3, label: "호흡 이상" },
  { keyword: "헉헉", weight: 3, label: "호흡 이상" },
