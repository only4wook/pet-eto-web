          ...
          <div style={{ padding: 24 }}>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ fontSize: 13, color: "#6B7280", margin: "0 0 16px", lineHeight: 1.6 }}>
                고양이를 처음 키울 때 꼭 해야 할 일을 순서대로 정리했어요. 예상 월 관리비: <strong style={{ color: ACCENT }}>{guide.monthlyMinCost}~{guide.monthlyMaxCost}</strong>
              </p>
              {/* 타임라인 */}
