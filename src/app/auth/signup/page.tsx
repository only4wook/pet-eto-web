      ...
      <main style={{ maxWidth: 440, margin: "0 auto", padding: "40px 16px", flex: 1, width: "100%" }}>
        <div style={{ background: "#fff", border: "1px solid #e0e0e0", borderRadius: 4, padding: 32 }}>
          ...
          <div style={{ margin: "20px 0 12px", display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <span style={{ fontSize: 12, color: "#9CA3AF" }}>간편 가입</span>
            <div style={{ flex: 1, height: 1, background: "#E5E7EB" }} />
          </div>
          <div style={{ display: "flex", gap: 10 }}>
            <button onClick={async () => {
              ...
              display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#374151",
            }}>
            ...
            <button onClick={async () => {
              ...
              display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#3C1E1E",
            }}>
              카카오
            </button>
            <button onClick={() => alert("네이버 로그인은 준비 중이에요!")} style={{
              flex: 1, padding: "10px", border: "none", borderRadius: 8,
              background: "#03C75A", cursor: "pointer", fontSize: 13, fontWeight: 600,
